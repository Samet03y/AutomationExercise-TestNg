...
public class ReusableMethods {
    ...
    public static void istenenlemanascrollyapma(WebDriver driver, WebElement scrollyapılacakelemet) {
...
/*
 JavascriptExecutor jse = (JavascriptExecutor) Driver.getDriver();
        jse.executeScript("arguments[0].scrollIntoViewIfNeeded(true);",asagiyaindirilecekLokeytElementi);


     WebDriverWait wait=new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(10));
        wait.until(ExpectedConditions.elementToBeClickable(bekletilecekLokeyt));
 */